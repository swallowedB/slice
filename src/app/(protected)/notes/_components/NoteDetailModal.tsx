...
export default function NoteDetailModal({
  ...
  return (
    <>
      <ModalBackground />
      <div className="fixed inset-y-0 right-0 left-0 z-1000 bg-white px-4 pt-12 pb-4 sm:px-10 sm:pt-18 sm:pb-10 lg:left-auto lg:w-200 lg:rounded-tl-4xl lg:rounded-bl-4xl lg:pt-20">
        <button
          type="button"
          aria-label="닫기"
          onClick={() => onClose()}
