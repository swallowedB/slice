      ...
      <section className="mb-6">
        <div className="block w-full gap-8 xl:grid-cols-2 2xl:grid">
          <div className="flex items-center gap-3 rounded-2xl bg-white px-4 py-4 sm:rounded-3xl sm:px-6 sm:py-6 md:px-3 md:py-8.75 xl:rounded-4xl xl:px-10 xl:py-15">
            ...
            />
            <h3 className="text-base font-semibold break-keep sm:text-xl xl:text-2xl">
              {goal.title}
            </h3>
          ...
          <div className="mt-4 block sm:mt-6 sm:grid sm:grid-cols-2 sm:gap-5 lg:block xl:grid xl:grid-cols-2 xl:gap-5 2xl:mt-0">
            ...
            <div className="mt-4 flex h-40 items-end rounded-4xl bg-blue-200 bg-[url('/images/goals/obj-note.png')] bg-[length:98px_auto] bg-[right_14px_top_14px] bg-no-repeat px-10 py-7.5 text-white shadow-[0_10px_40px_0_rgba(0,212,190,0.24)] transition-all sm:bg-[right_4px_top_14px] lg:mt-5 lg:py-11.5 lg:hover:shadow-[0_10px_40px_0_rgba(0,212,190,0.24)] 2xl:mt-0">
              <Link
                href="/notes/1"
